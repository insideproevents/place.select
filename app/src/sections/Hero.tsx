...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-end overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-12 pb-12 sm:pb-16 lg:pb-20 w-full">
        ...
        <motion.div
          ...
          className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10 flex flex-wrap items-center gap-3 sm:gap-6"
        >
