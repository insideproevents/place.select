...
export default function Hero() {
  return (
    <section className="relative h-[100dvh] sm:h-[100dvh] flex flex-col justify-end overflow-hidden">
      ...
      {/* Content */}
<div className="relative z-10 max-w-[1280px] ml-[-15px] px-4 sm:px-6 lg:px-12 pb-[22px] sm:pb-[94px] lg:pb-[97px] w-full">
        <div className="max-w-2xl">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: 'easeOut' }}
className="font-display text-[22px] sm:text-4xl lg:text-5xl xl:text-6xl text-white uppercase tracking-[0.15em] leading-tight"
          >
